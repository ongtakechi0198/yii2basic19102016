...
<div class="wrap">
    ...
    <?php
    NavBar::begin([
        'brandLabel' => '<span class="glyphicon glyphicon-import"></span> My WebSite',
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => '<span class="glyphicon glyphicon-credit-card"></span> เกี่ยวกับ', 'url' => ['/site/about']],
            ['label' => '<span class="glyphicon glyphicon-phone-alt"></span> ติดต่อ', 'url' => ['/site/contact']],
            Yii::$app->user->isGuest ? (
                ['label' => '<span class="glyphicon glyphicon-user"></span> เข้าสู่ระบบ', 'url' => ['/site/login']]
            ) : (
                '<li>'
